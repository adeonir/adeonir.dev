...
- **Quality budget (manual target — not yet CI-enforced):** mobile Lighthouse Performance ≥ 95, Accessibility/Best-Practices/SEO 100; LCP < 2.0s, CLS < 0.1, INP < 200ms; WCAG 2.1 AA. CI runs lint/typecheck/build only; the Lighthouse-CI + axe gate is the design's plan, not yet wired.
